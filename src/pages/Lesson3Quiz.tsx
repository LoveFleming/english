...
import quizDataRaw from "../data/lesson3/quiz_questions.json";
  ...
  if (phase === "setup") {
    return (
      <div className="max-w-2xl mx-auto py-6 px-2">
        <h1 className="text-2xl sm:text-3xl font-bold text-stone-900 mb-2">📝 7下 Lesson 3 Quiz</h1>
        <p className="text-stone-500 mb-6">Numbers, Dates & Pronouns — 選擇題目類型，開始測驗！</p>
