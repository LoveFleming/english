...
import markdownContent from "../data/parts-of-speech/parts-of-speech.md?raw";

export default function PartsOfSpeech({ openApp }: { openApp: (id: string) => void }) {
  return (
    <div className="space-y-6 max-w-4xl animate-in slide-in-from-bottom-2 duration-500">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-4 pb-4 border-b border-zinc-200">
        <h1 className="text-3xl font-bold text-stone-900 tracking-tight">詞性大冒險 🎯</h1>
        <button
          onClick={() => openApp("quiz.parts-of-speech")}
